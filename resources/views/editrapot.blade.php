...
<h2><center> Edit Data Raport Siswa</center></h2><br>
<form action="/rapot/updaterapot/{{$rapot->id}}" method="POST">
                {{csrf_field()}}
                <input type="hidden" name="id" value="{{$rapot->id}}"><br>
                <div class="form-group">
                <label for="id">No</label>
                <input type="text" class="form-control"
                    required="required" name="id" value="{{$rapot->id}}"><br>
                </div>
                <div class="form-group">
                <label for="nama">Nama Lengkap</label>
                <input type="text" class="form-control"
                    required="required" name="nama" value="{{$rapot->nama}}"><br>
                </div>
                <div class="form-group">
                <label for="ttl">Tempat, Tanggal lahir</label>
                <input type="text" class="form-control"
                    required="required" name="ttl" value="{{$rapot->ttl}}"><br>
                </div>
                <div class="form-group">
                <label for="alamat">Alamat</label>
                <input type="text" class="form-control"
                    required="required" name="alamat" value="{{$rapot->alamat}}"><br>
                </div>
                <div class="form-group">
                <label for="kelas">Kelas</label>
                <input type="text" class="form-control"
                    required="required" name="kelas" value="{{$rapot->kelas}}"><br>
                </div>
                <div class="form-group">
                <label for="semester">Semester</label>
                <input type="text" class="form-control"
                    required="required" name="semester" value="{{$rapot->semester}}"><br>
                </div>
                <div class="form-group">
                <label for="pelajaran">Peringkat</label>
                <input type="text" class="form-control"
                    required="required" name="pelajaran" value="{{$rapot->pelajaran}}"><br>
                </div>
                <div class="form-group">
                <label for="nilai">Nilai</label>
                <input type="text" class="form-control"
                    required="required" name="nilai" value="{{$rapot->nilai}}"><br>
                </div>
                <div class="form-group">
                <label for="walikelas">Wali Kelas</label>
                <input type="text" class="form-control"
                    required="required" name="walikelas" value="{{$rapot->walikelas}}"><br>
                </div>
                <div class="form-group">
                <label for="kepalasekolah">Kepala Sekolah</label>
                <input type="text" class="form-control"
                    required="required" name="kepalasekolah" value="{{$rapot->kepalasekolah}}"><br>
                </div>
                <button type="submit" name="editrapot" class="btn btn-primary">Edit Data</button>
                </form>
        </div>
      </div>
    </div>
