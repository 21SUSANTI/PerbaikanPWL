...
<div class="card-header" style="background-color:#90EE90"><center>
<h2> Tambah Data Guru Tahun 2020/2021</h2><br>
<form action="/guru" method="post">
   ...
   @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" required="required" name="jabatan"></br>
    </div>
    <div class="form-group">
        <label for="kelas">Kelas</label>
        <input type="text" class="form-control" required="required" name="kelas"></br>
    </div>
    <button type="submit" name="addguru" class="btn btn-primary">Tambah Data</button>
</form></div></div>
