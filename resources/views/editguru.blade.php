...
<h2><center> Edit Data Guru Tahun 2020/2021 </center></h2><br>
<form action="/guru/updateguru/{{$guru->id}}" method="POST">
                {{csrf_field()}}
                <input type="hidden" name="id" value="{{$guru->id}}"><br>
                <div class="form-group">
                <label for="id">No</label>
                <input type="text" class="form-control"
                    required="required" name="id" value="{{$guru->id}}"><br>
                </div>
                <div class="form-group">
                <label for="nama">Nama Lengkap</label>
                <input type="text" class="form-control"
                    required="required" name="nama" value="{{$guru->nama}}"><br>
                </div>
                <div class="form-group">
                <label for="ttl">Tempat, Tanggal lahir</label>
                <input type="text" class="form-control"
                    required="required" name="ttl" value="{{$guru->ttl}}"><br>
                </div>
                <div class="form-group">
                <label for="alamat">Alamat</label>
                <input type="text" class="form-control"
                    required="required" name="alamat" value="{{$guru->alamat}}"><br>
                </div>
                <div class="form-group">
                <label for="jabatan">Jabatan</label>
                <input type="text" class="form-control"
                    required="required" name="jabatan" value="{{$guru->jabatan}}"><br>
                </div>
                <div class="form-group">
                <label for="kelas">Kelas</label>
                <input type="text" class="form-control"
                    required="required" name="kelas" value="{{$guru->kelas}}"><br>
                </div>
                <button type="submit" name="editguru" class="btn btn-primary">Edit Data</button>
                </form>
        </div>
      </div>
    </div>
